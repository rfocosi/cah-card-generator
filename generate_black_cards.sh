#!/bin/bash
generatedFolder="generated/black"
...
do
    ...
    if [ "$newPage" == "1" ]
    then
       sourceFile="CAH_BlankBlackCards.jpg"
       newPage=0
    fi
    ...
    convert -weight bold -pointsize $((pointSize)) -fill white -draw "text $((posCol+42)),$((posRow+85)) '$line1' text $((posCol+42)),$((posRow+115)) '$line2' text $((posCol+42)),$((posRow+145)) '$line3' text $((posCol+42)),$((posRow+175)) '$line4' text $((posCol+42)),$((posRow+205)) '$line5'" "$sourceFile" "$outputFile"
    if [ "$pick" == "2" ] 
    then
